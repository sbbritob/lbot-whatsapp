...
module.exports = {
    ...
    grupo:{
        ...
        setranking: cabecalho+
        "Ex: *!setranking* - coleta dados da vila do usuário",
        setestrelas: cabecalho+
        "Ex: *!setestrelas* - coleta dados as estrelas do usuário",
        status: cabecalho+
        ...
        autoreacao: cabecalho+
        "Ex: *!autoreacao* - Liga/desliga a reação automática de falas sem precisar de comandos.",
        add: cabecalho+
        ...
        dinamica: cabecalho+
        "Ex: *!dinamica* - Marca todos os *MEMBROS/ADMIN* do grupo.\n\n",
        mt: cabecalho+
