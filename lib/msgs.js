const msgs_texto = {
    ...
    downloads: {
        ...
        ig: {
            ...
            erro_download: "[❗] Houve um erro no download de uma ou mais mídias do Instagram, tente novamente mais tarde.\n\n" +
    ...
    grupo: {
        ...
        bemvindo: {
            ...
            mensagem: "👋 Olá, Seja bem-vindo(a) @{p1}\n" +
                "ao grupo *{p2}*\n\n" +
                "{p3}"
        },
        status: {
        ...
        dinamica: {
            resposta_titulo_comum: "══✪〘🤖 DINÂMICA 〙✪══\n",
        },
        mt: {
            resposta_titulo_comum: "╔══✪〘🤖 Marcando Todos 〙\n",
            resposta_titulo_variavel: "═════════════════\n"+
            "╔══✪〘{p1}〙\n",
            resposta_itens: "╠➥ @{p1}\n"
        },
        mm: {
